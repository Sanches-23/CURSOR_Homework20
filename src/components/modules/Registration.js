    ...
    return (
        <div className={auth.container}>
            <div className={auth.wrapper}>
                <div className={auth.imageContainer}>
                    <div className={auth.imageCircle}>
                        <img
                ...
                <form onSubmit={handleSubmit(onSubmit)} className={auth.wrapper}>
                    <div className={auth.fullNameInputs}>
                        {errors.firstName && (
                    ...
                    <div className={auth.fullNameInputs}>
                        <input className={auth.inputAuth}
                               type="text"
                               placeholder="First name"
                               {...register('firstName', {
                                   required: 'FirstName is required*',
                    ...
                    />
                    <label className={auth.labelCheckbox}>
                        <input className={auth.checkbox}
                               type="checkbox"
                               checked={mailing}
                               onChange={() => setMailing(!mailing)}
                        />
